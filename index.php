...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@QAZAQELI.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+7777 777 77 77</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">QAZAQ <span>ELI</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">QAZAQ ELI</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our QAZAQ ELI</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
			...
			<div class="contact-agileits">
				...
				<form method="post" name="sentMessage" id="contactForm">
                    ...
                    <div class="control-group form-group">
                            ...
                            <label class="contact-p1">Telegram account:</label>
                            <input type="text" class="form-control" name="telegram" id="telegram" style="font-size:17px; font-weight:normal; color:#fff; background-color:transparent; border-radius:0;border-color:#fff; font-family: 'Lato', sans-serif;" required >
							<p class="help-block"></p>
				...
				if(isset($_POST['sub']))
				{
					...
					$token = "1610336279:AAH4LJ02Zgsd_EJoiddNXrcgYiuUqBCCzfA";
					$chat_id = "-471222904";
					$arr = array(
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+7 777 777 77 77</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@QAZAQELI.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Mangilik Eli Road, Nur-Sultan, Kazakhstan</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 QAZAQ ELI. All Rights Reserved | Design by <a href="index.php">QAZAQ ELI</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
