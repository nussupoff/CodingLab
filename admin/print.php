...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>QAZAQ ELI HOTEL,</p>
				<p>Mangilik eli road,<br>Nur-Sultan,<br>Kazakhstan.</p>
				<p>+7 777 777 77 77</p>
			</address>
			<span><img alt="" src="assets/img/qazaq.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@qazaqeli.com || Web :- www.qazaqeli.com || Phone :- +7 777 777 77 77</p>
			</div>
		</aside>
	</body>
</html>
